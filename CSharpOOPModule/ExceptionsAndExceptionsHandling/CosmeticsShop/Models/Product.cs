    ...
    public class Product
    {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidNameException("Product name should be between 3 and 10 symbols.");
                }
                this.name = value;
            }
        }
        ...
        public string Brand
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidBrandException("Product brand should be between 2 and 10 symbols.");
                }
                this.brand = value;
            }
        }
        ...
        public double Price
        {
            ...
            set
            {
                if (value < 0)
                {
                    throw new InvalidPriceException("Product price can not be negative.");
                }
                this.price = value;
            }
        }
